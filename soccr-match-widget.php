...
class Soccr_Widget_Match extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        <p>
            ...
            <span id="<?php echo $this->get_field_id('soccr_next_match_team_option_na'); ?>" style="display: <?php if ($displayNoTeamsInfo): echo "block";
        else: echo "none";
        endif; ?>;">No Teams for this League and Season avaibile. Widget can't be saved</span>
        </p>
                <?php
            }
